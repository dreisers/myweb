	...
	<form name="check1" onsubmit="return checked(this)">
		<table>
			...
			<tr id="showHide">
				...
				<td><input type="hidden" name="noticeno" value="<%=dto.getNoticeno()%>"> <input type="button" name="delete" value="삭제" onclick="mdelete(this.form)"></td>
				</form>
			</tr>
			<%
				} //for end
			...
			<tr>
				<td colspan="7" style="text-align: center; height: 20px;">
					<form method="get" action="ad_notice_List.jsp" onsubmit="return searchCheck(this)">
						<select name="col" class="checkbox1"><option value="subject">제목</select> <input type="text" name="word" class="textbox1">
	...
	<script>
		...
		function showHide() {
			if (document.getElementById("showHide").style.display == 'none') {
				document.getElementById("showHide").style.display = 'table-row'; //default값 확인하기 
			} else {
