...
<input type="button" value="전체글 보기" class="button2" onclick="window.location='bbsList.jsp';">
...
ArrayList<BbsDTO> list=dao.comment(col, word, nowPage, recordPerPage); //글 목록
if(list==null){
...
%>
	<tr>
	  <td colspan="4">
<%
	  String paging = new Paging().paging3(totalRecord, nowPage, recordPerPage, col, word, "bbsComment.jsp");
	  out.println(paging);
%>
	  </td>
	</tr>
