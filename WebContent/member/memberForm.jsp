...
<tr>
	<th class="th1">* 아이디</th>
	<td class="td1">
      <input type="text" name="id" id="id" size="10" readonly class="membertext">
      <input type="button" value="ID중복확인"  onclick="idCheck()" class="button1"> * 5~10글자 이내
	</td>
</tr>
<tr>
...
<tr>
	<th class="th1">* 이름</th>
	<td class="td1"><input type="text" name="mname" id="mname" size="10" required class="membertext"></td>
</tr>
<tr>
	<th class="th1">* 이메일</th>
	<td class="td1">
      <input type="text" name="email" id="email" size="20" readonly class="membertext">
      <input type="button" value="Email 중복확인" onclick="emailCheck()" class="button1">	
	</td>
</tr>
<tr>
	<th class="th2">* 전화번호</th>
	<td class="td1"><input type="text" name="tel" id="tel" size="13" required class="membertext"></td>
</tr>
<tr>
	<th class="th2">우편번호</th>
	<td class="td1">
      <input type="text" name="zipcode" id="zipcode" size="7"  readonly class="membertext">
      <input type="button" value="주소찾기"  onclick="DaumPostcode()" class="button1">	
	</td>
</tr>
<tr>  
  <th class="th2">주소</th>
  <td class="td1"><input type="text" name="address1" id="address1" size="25" readonly class="membertext"></td>
</tr>
<tr>  
  <th class="th2">나머지주소</th>
  <td class="td1"><input type="text" name="address2" id="address2" size="30" class="membertext"></td>
</tr>
<tr>  
  <th class="th2">직업</th>
